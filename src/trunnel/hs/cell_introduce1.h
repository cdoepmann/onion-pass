...
#define TRUNNEL_CELL_EXTENSION_TYPE_HS_DOS 1
#define TRUNNEL_CELL_EXTENSION_HS_DOS_DLEQ_PK_LEN 64
#define TRUNNEL_CELL_EXTENSION_HS_DOS_TOKEN_LEN 32
#define TRUNNEL_CELL_EXTENSION_HS_DOS_MAC_LEN 32
#if !defined(TRUNNEL_OPAQUE) && !defined(TRUNNEL_OPAQUE_TRN_CELL_EXTENSION_HS_DOS)
struct trn_cell_extension_hs_dos_st {
  uint8_t pub_key[TRUNNEL_CELL_EXTENSION_HS_DOS_DLEQ_PK_LEN];
  uint8_t token[TRUNNEL_CELL_EXTENSION_HS_DOS_TOKEN_LEN];
  uint8_t redemption_mac[TRUNNEL_CELL_EXTENSION_HS_DOS_MAC_LEN];
  uint8_t trunnel_error_code_;
};
#endif
typedef struct trn_cell_extension_hs_dos_st trn_cell_extension_hs_dos_t;
...
/** Return a newly allocated trn_cell_extension_hs_dos with all
 * elements set to zero.
 */
trn_cell_extension_hs_dos_t *trn_cell_extension_hs_dos_new(void);
/** Release all storage held by the trn_cell_extension_hs_dos in
 * 'victim'. (Do nothing if 'victim' is NULL.)
 */
void trn_cell_extension_hs_dos_free(trn_cell_extension_hs_dos_t *victim);
/** Try to parse a trn_cell_extension_hs_dos from the buffer in
 * 'input', using up to 'len_in' bytes from the input buffer. On
 * success, return the number of bytes consumed and set *output to the
 * newly allocated trn_cell_extension_hs_dos_t. On failure, return -2
 * if the input appears truncated, and -1 if the input is otherwise
 * invalid.
 */
ssize_t trn_cell_extension_hs_dos_parse(trn_cell_extension_hs_dos_t **output, const uint8_t *input, const size_t len_in);
/** Return the number of bytes we expect to need to encode the
 * trn_cell_extension_hs_dos in 'obj'. On failure, return a negative
 * value. Note that this value may be an overestimate, and can even be
 * an underestimate for certain unencodeable objects.
 */
ssize_t trn_cell_extension_hs_dos_encoded_len(const trn_cell_extension_hs_dos_t *obj);
/** Try to encode the trn_cell_extension_hs_dos from 'input' into the
 * buffer at 'output', using up to 'avail' bytes of the output buffer.
 * On success, return the number of bytes used. On failure, return -2
 * if the buffer was not long enough, and -1 if the input was invalid.
 */
ssize_t trn_cell_extension_hs_dos_encode(uint8_t *output, size_t avail, const trn_cell_extension_hs_dos_t *input);
/** Check whether the internal state of the trn_cell_extension_hs_dos
 * in 'obj' is consistent. Return NULL if it is, and a short message
 * if it is not.
 */
const char *trn_cell_extension_hs_dos_check(const trn_cell_extension_hs_dos_t *obj);
/** Clear any errors that were set on the object 'obj' by its setter
 * functions. Return true iff errors were cleared.
 */
int trn_cell_extension_hs_dos_clear_errors(trn_cell_extension_hs_dos_t *obj);
/** Return the (constant) length of the array holding the pub_key
 * field of the trn_cell_extension_hs_dos_t in 'inp'.
 */
size_t trn_cell_extension_hs_dos_getlen_pub_key(const trn_cell_extension_hs_dos_t *inp);
/** Return the element at position 'idx' of the fixed array field
 * pub_key of the trn_cell_extension_hs_dos_t in 'inp'.
 */
uint8_t trn_cell_extension_hs_dos_get_pub_key(trn_cell_extension_hs_dos_t *inp, size_t idx);
/** As trn_cell_extension_hs_dos_get_pub_key, but take and return a
 * const pointer
 */
uint8_t trn_cell_extension_hs_dos_getconst_pub_key(const trn_cell_extension_hs_dos_t *inp, size_t idx);
/** Change the element at position 'idx' of the fixed array field
 * pub_key of the trn_cell_extension_hs_dos_t in 'inp', so that it
 * will hold the value 'elt'.
 */
int trn_cell_extension_hs_dos_set_pub_key(trn_cell_extension_hs_dos_t *inp, size_t idx, uint8_t elt);
/** Return a pointer to the TRUNNEL_CELL_EXTENSION_HS_DOS_DLEQ_PK_LEN-
 * element array field pub_key of 'inp'.
 */
uint8_t * trn_cell_extension_hs_dos_getarray_pub_key(trn_cell_extension_hs_dos_t *inp);
/** As trn_cell_extension_hs_dos_get_pub_key, but take and return a
 * const pointer
 */
const uint8_t  * trn_cell_extension_hs_dos_getconstarray_pub_key(const trn_cell_extension_hs_dos_t *inp);
/** Return the (constant) length of the array holding the token field
 * of the trn_cell_extension_hs_dos_t in 'inp'.
 */
size_t trn_cell_extension_hs_dos_getlen_token(const trn_cell_extension_hs_dos_t *inp);
/** Return the element at position 'idx' of the fixed array field
 * token of the trn_cell_extension_hs_dos_t in 'inp'.
 */
uint8_t trn_cell_extension_hs_dos_get_token(trn_cell_extension_hs_dos_t *inp, size_t idx);
/** As trn_cell_extension_hs_dos_get_token, but take and return a
 * const pointer
 */
uint8_t trn_cell_extension_hs_dos_getconst_token(const trn_cell_extension_hs_dos_t *inp, size_t idx);
/** Change the element at position 'idx' of the fixed array field
 * token of the trn_cell_extension_hs_dos_t in 'inp', so that it will
 * hold the value 'elt'.
 */
int trn_cell_extension_hs_dos_set_token(trn_cell_extension_hs_dos_t *inp, size_t idx, uint8_t elt);
/** Return a pointer to the TRUNNEL_CELL_EXTENSION_HS_DOS_TOKEN_LEN-
 * element array field token of 'inp'.
 */
uint8_t * trn_cell_extension_hs_dos_getarray_token(trn_cell_extension_hs_dos_t *inp);
/** As trn_cell_extension_hs_dos_get_token, but take and return a
 * const pointer
 */
const uint8_t  * trn_cell_extension_hs_dos_getconstarray_token(const trn_cell_extension_hs_dos_t *inp);
/** Return the (constant) length of the array holding the
 * redemption_mac field of the trn_cell_extension_hs_dos_t in 'inp'.
 */
size_t trn_cell_extension_hs_dos_getlen_redemption_mac(const trn_cell_extension_hs_dos_t *inp);
/** Return the element at position 'idx' of the fixed array field
 * redemption_mac of the trn_cell_extension_hs_dos_t in 'inp'.
 */
uint8_t trn_cell_extension_hs_dos_get_redemption_mac(trn_cell_extension_hs_dos_t *inp, size_t idx);
/** As trn_cell_extension_hs_dos_get_redemption_mac, but take and
 * return a const pointer
 */
uint8_t trn_cell_extension_hs_dos_getconst_redemption_mac(const trn_cell_extension_hs_dos_t *inp, size_t idx);
/** Change the element at position 'idx' of the fixed array field
 * redemption_mac of the trn_cell_extension_hs_dos_t in 'inp', so that
 * it will hold the value 'elt'.
 */
int trn_cell_extension_hs_dos_set_redemption_mac(trn_cell_extension_hs_dos_t *inp, size_t idx, uint8_t elt);
/** Return a pointer to the TRUNNEL_CELL_EXTENSION_HS_DOS_MAC_LEN-
 * element array field redemption_mac of 'inp'.
 */
uint8_t * trn_cell_extension_hs_dos_getarray_redemption_mac(trn_cell_extension_hs_dos_t *inp);
/** As trn_cell_extension_hs_dos_get_redemption_mac, but take and
 * return a const pointer
 */
const uint8_t  * trn_cell_extension_hs_dos_getconstarray_redemption_mac(const trn_cell_extension_hs_dos_t *inp);

...
trn_cell_extension_hs_dos_t *
trn_cell_extension_hs_dos_new(void)
{
  trn_cell_extension_hs_dos_t *val = trunnel_calloc(1, sizeof(trn_cell_extension_hs_dos_t));
  if (NULL == val)
    return NULL;
  return val;
}
 ...
 */
static void
trn_cell_extension_hs_dos_clear(trn_cell_extension_hs_dos_t *obj)
{
  (void) obj;
}

void
trn_cell_extension_hs_dos_free(trn_cell_extension_hs_dos_t *obj)
{
  if (obj == NULL)
    return;
  trn_cell_extension_hs_dos_clear(obj);
  trunnel_memwipe(obj, sizeof(trn_cell_extension_hs_dos_t));
  trunnel_free_(obj);
}

size_t
trn_cell_extension_hs_dos_getlen_pub_key(const trn_cell_extension_hs_dos_t *inp)
{
  (void)inp;  return TRUNNEL_CELL_EXTENSION_HS_DOS_DLEQ_PK_LEN;
}

uint8_t
trn_cell_extension_hs_dos_get_pub_key(trn_cell_extension_hs_dos_t *inp, size_t idx)
{
  trunnel_assert(idx < TRUNNEL_CELL_EXTENSION_HS_DOS_DLEQ_PK_LEN);
  return inp->pub_key[idx];
}

uint8_t
trn_cell_extension_hs_dos_getconst_pub_key(const trn_cell_extension_hs_dos_t *inp, size_t idx)
{
  return trn_cell_extension_hs_dos_get_pub_key((trn_cell_extension_hs_dos_t*)inp, idx);
}
int
trn_cell_extension_hs_dos_set_pub_key(trn_cell_extension_hs_dos_t *inp, size_t idx, uint8_t elt)
{
  trunnel_assert(idx < TRUNNEL_CELL_EXTENSION_HS_DOS_DLEQ_PK_LEN);
  inp->pub_key[idx] = elt;
  return 0;
...
uint8_t *
trn_cell_extension_hs_dos_getarray_pub_key(trn_cell_extension_hs_dos_t *inp)
{
  return inp->pub_key;
}
const uint8_t  *
trn_cell_extension_hs_dos_getconstarray_pub_key(const trn_cell_extension_hs_dos_t *inp)
{
  return (const uint8_t  *)trn_cell_extension_hs_dos_getarray_pub_key((trn_cell_extension_hs_dos_t*)inp);
}
size_t
trn_cell_extension_hs_dos_getlen_token(const trn_cell_extension_hs_dos_t *inp)
{
  (void)inp;  return TRUNNEL_CELL_EXTENSION_HS_DOS_TOKEN_LEN;
}

uint8_t
trn_cell_extension_hs_dos_get_token(trn_cell_extension_hs_dos_t *inp, size_t idx)
{
  trunnel_assert(idx < TRUNNEL_CELL_EXTENSION_HS_DOS_TOKEN_LEN);
  return inp->token[idx];
}

uint8_t
trn_cell_extension_hs_dos_getconst_token(const trn_cell_extension_hs_dos_t *inp, size_t idx)
{
  return trn_cell_extension_hs_dos_get_token((trn_cell_extension_hs_dos_t*)inp, idx);
}
int
trn_cell_extension_hs_dos_set_token(trn_cell_extension_hs_dos_t *inp, size_t idx, uint8_t elt)
{
  trunnel_assert(idx < TRUNNEL_CELL_EXTENSION_HS_DOS_TOKEN_LEN);
  inp->token[idx] = elt;
  return 0;
...
uint8_t *
trn_cell_extension_hs_dos_getarray_token(trn_cell_extension_hs_dos_t *inp)
{
  return inp->token;
}
const uint8_t  *
trn_cell_extension_hs_dos_getconstarray_token(const trn_cell_extension_hs_dos_t *inp)
{
  return (const uint8_t  *)trn_cell_extension_hs_dos_getarray_token((trn_cell_extension_hs_dos_t*)inp);
}
size_t
trn_cell_extension_hs_dos_getlen_redemption_mac(const trn_cell_extension_hs_dos_t *inp)
{
  (void)inp;  return TRUNNEL_CELL_EXTENSION_HS_DOS_MAC_LEN;
}

uint8_t
trn_cell_extension_hs_dos_get_redemption_mac(trn_cell_extension_hs_dos_t *inp, size_t idx)
{
  trunnel_assert(idx < TRUNNEL_CELL_EXTENSION_HS_DOS_MAC_LEN);
  return inp->redemption_mac[idx];
}

uint8_t
trn_cell_extension_hs_dos_getconst_redemption_mac(const trn_cell_extension_hs_dos_t *inp, size_t idx)
{
  return trn_cell_extension_hs_dos_get_redemption_mac((trn_cell_extension_hs_dos_t*)inp, idx);
}
int
trn_cell_extension_hs_dos_set_redemption_mac(trn_cell_extension_hs_dos_t *inp, size_t idx, uint8_t elt)
{
  trunnel_assert(idx < TRUNNEL_CELL_EXTENSION_HS_DOS_MAC_LEN);
  inp->redemption_mac[idx] = elt;
  return 0;
}

uint8_t *
trn_cell_extension_hs_dos_getarray_redemption_mac(trn_cell_extension_hs_dos_t *inp)
{
  return inp->redemption_mac;
}
const uint8_t  *
trn_cell_extension_hs_dos_getconstarray_redemption_mac(const trn_cell_extension_hs_dos_t *inp)
{
  return (const uint8_t  *)trn_cell_extension_hs_dos_getarray_redemption_mac((trn_cell_extension_hs_dos_t*)inp);
}
const char *
trn_cell_extension_hs_dos_check(const trn_cell_extension_hs_dos_t *obj)
{
  if (obj == NULL)
...
ssize_t
trn_cell_extension_hs_dos_encoded_len(const trn_cell_extension_hs_dos_t *obj)
{
  ssize_t result = 0;

  if (NULL != trn_cell_extension_hs_dos_check(obj))
     return -1;


  /* Length of u8 pub_key[TRUNNEL_CELL_EXTENSION_HS_DOS_DLEQ_PK_LEN] */
  result += TRUNNEL_CELL_EXTENSION_HS_DOS_DLEQ_PK_LEN;

  /* Length of u8 token[TRUNNEL_CELL_EXTENSION_HS_DOS_TOKEN_LEN] */
  result += TRUNNEL_CELL_EXTENSION_HS_DOS_TOKEN_LEN;

  /* Length of u8 redemption_mac[TRUNNEL_CELL_EXTENSION_HS_DOS_MAC_LEN] */
  result += TRUNNEL_CELL_EXTENSION_HS_DOS_MAC_LEN;
  return result;
}
int
trn_cell_extension_hs_dos_clear_errors(trn_cell_extension_hs_dos_t *obj)
{
...
ssize_t
trn_cell_extension_hs_dos_encode(uint8_t *output, const size_t avail, const trn_cell_extension_hs_dos_t *obj)
{
  ssize_t result = 0;
  size_t written = 0;
  uint8_t *ptr = output;
  ...
  const ssize_t encoded_len = trn_cell_extension_hs_dos_encoded_len(obj);
#endif

  if (NULL != (msg = trn_cell_extension_hs_dos_check(obj)))
    goto check_failed;
  ...
  /* Encode u8 pub_key[TRUNNEL_CELL_EXTENSION_HS_DOS_DLEQ_PK_LEN] */
  trunnel_assert(written <= avail);
  if (avail - written < TRUNNEL_CELL_EXTENSION_HS_DOS_DLEQ_PK_LEN)
    goto truncated;
  memcpy(ptr, obj->pub_key, TRUNNEL_CELL_EXTENSION_HS_DOS_DLEQ_PK_LEN);
  written += TRUNNEL_CELL_EXTENSION_HS_DOS_DLEQ_PK_LEN; ptr += TRUNNEL_CELL_EXTENSION_HS_DOS_DLEQ_PK_LEN;

  /* Encode u8 token[TRUNNEL_CELL_EXTENSION_HS_DOS_TOKEN_LEN] */
  trunnel_assert(written <= avail);
  if (avail - written < TRUNNEL_CELL_EXTENSION_HS_DOS_TOKEN_LEN)
    goto truncated;
  memcpy(ptr, obj->token, TRUNNEL_CELL_EXTENSION_HS_DOS_TOKEN_LEN);
  written += TRUNNEL_CELL_EXTENSION_HS_DOS_TOKEN_LEN; ptr += TRUNNEL_CELL_EXTENSION_HS_DOS_TOKEN_LEN;

  /* Encode u8 redemption_mac[TRUNNEL_CELL_EXTENSION_HS_DOS_MAC_LEN] */
  trunnel_assert(written <= avail);
  if (avail - written < TRUNNEL_CELL_EXTENSION_HS_DOS_MAC_LEN)
    goto truncated;
  memcpy(ptr, obj->redemption_mac, TRUNNEL_CELL_EXTENSION_HS_DOS_MAC_LEN);
  written += TRUNNEL_CELL_EXTENSION_HS_DOS_MAC_LEN; ptr += TRUNNEL_CELL_EXTENSION_HS_DOS_MAC_LEN;
...
/** As trn_cell_extension_hs_dos_parse(), but do not allocate the
 * output object.
 */
static ssize_t
trn_cell_extension_hs_dos_parse_into(trn_cell_extension_hs_dos_t *obj, const uint8_t *input, const size_t len_in)
{
  ...
  /* Parse u8 pub_key[TRUNNEL_CELL_EXTENSION_HS_DOS_DLEQ_PK_LEN] */
  CHECK_REMAINING(TRUNNEL_CELL_EXTENSION_HS_DOS_DLEQ_PK_LEN, truncated);
  memcpy(obj->pub_key, ptr, TRUNNEL_CELL_EXTENSION_HS_DOS_DLEQ_PK_LEN);
  remaining -= TRUNNEL_CELL_EXTENSION_HS_DOS_DLEQ_PK_LEN; ptr += TRUNNEL_CELL_EXTENSION_HS_DOS_DLEQ_PK_LEN;

  /* Parse u8 token[TRUNNEL_CELL_EXTENSION_HS_DOS_TOKEN_LEN] */
  CHECK_REMAINING(TRUNNEL_CELL_EXTENSION_HS_DOS_TOKEN_LEN, truncated);
  memcpy(obj->token, ptr, TRUNNEL_CELL_EXTENSION_HS_DOS_TOKEN_LEN);
  remaining -= TRUNNEL_CELL_EXTENSION_HS_DOS_TOKEN_LEN; ptr += TRUNNEL_CELL_EXTENSION_HS_DOS_TOKEN_LEN;

  /* Parse u8 redemption_mac[TRUNNEL_CELL_EXTENSION_HS_DOS_MAC_LEN] */
  CHECK_REMAINING(TRUNNEL_CELL_EXTENSION_HS_DOS_MAC_LEN, truncated);
  memcpy(obj->redemption_mac, ptr, TRUNNEL_CELL_EXTENSION_HS_DOS_MAC_LEN);
  remaining -= TRUNNEL_CELL_EXTENSION_HS_DOS_MAC_LEN; ptr += TRUNNEL_CELL_EXTENSION_HS_DOS_MAC_LEN;
...
ssize_t
trn_cell_extension_hs_dos_parse(trn_cell_extension_hs_dos_t **output, const uint8_t *input, const size_t len_in)
{
  ssize_t result;
  *output = trn_cell_extension_hs_dos_new();
  if (NULL == *output)
    return -1;
  result = trn_cell_extension_hs_dos_parse_into(*output, input, len_in);
  if (result < 0) {
    trn_cell_extension_hs_dos_free(*output);
    *output = NULL;
  }
  return result;
}
